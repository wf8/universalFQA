		...
		<div class="nice_margins">
			<div class="row-fluid">
				...
				<div class="span11">
					...
					<button class="btn btn-info" onclick="javascript:window.location = 'view_transect.php';return false;">Save and View Results</button> 
			...
			<div class="row-fluid">
				...
				<!-- include code here to create site if none exist -->
				<div class="span6">
